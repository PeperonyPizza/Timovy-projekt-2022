...
addpath("genetic")
%=========================================================================>
%               TRÉNOVANIE NEURÓNOVEJ SIETE - DISKRÉTNA FORMA
%=========================================================================>
%% %%%%%%%%%%%%%%%%%%   VOĽBA PARAMETROV GA  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numgen = 150;             % počet generácii
...
for gen = 1:numgen
    ...
    %     end
        ...
        orientacia = 3;     % natočenie - hodnota 0 až 4:
                            % smer: 0 nahor, 1 doprava, 2 dole, 3 doľava
        predosla_zmena = 0; 
        pp = 0;             % pokutovanie
...
%             end 
            ...
            pp = 1 + pp + pokuta + pokuta_vybocenie + pokuta_ciklus + pokuta_vzdialenost_od_cp - 100 * mensia_vzdialenost - prejdenie_cp * 500000;
        end
