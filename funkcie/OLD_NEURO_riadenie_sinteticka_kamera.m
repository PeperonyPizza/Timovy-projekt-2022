...
clear
addpath("genetic")
numgen = 400; % pocet generacii
lpop = 25;	   % pocet chromozonov v populacii
lstring = 450; % pocet genov v chromozone (90+100+10)200
...
%%%%%% NASTAVENIE MAPY %%%%%%
trasa_num = 5;      %vyber mapy: 1 = stvorec
                    %            2 = race track
                    %            3 = kruh
                    %            4 = osmicka
                    %            5 = sestuholnik
                    %            6 = race track_2
pocetSpusteni = 2;  %pre dalsie spustenie sa vygeneruje nova populacia
kroky = 450;        %dt
...
%         neuro_imput_image=rotacia_obrazu_v1_BW(start,cesta,checkpoints, [pozicia(2),pozicia(1)], stupne_pre_kameru, 5,0);
...
%             if rows_im < 4 || collums_im<6  
%                 empti_image=ones([4 6])*255;
%                 for row_n=1:1:rows_im
%                     for coll_n = 1:1:collums_im
%                         empti_image(row_n,coll_n) = neuro_imput_image(row_n,coll_n);
%                     end
%                 end
%             end
