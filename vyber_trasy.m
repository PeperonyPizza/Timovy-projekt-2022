...
elseif(trasa_num == 2)  %race track
    ...
    prekazky = [38 61,12 41,28 15,66 34,103 21,125 11,135 34,114 59,109 87,112 116,73 120,25 123,25 100];
%     prekazky = [38 61,25 48,12 41,11 28,28 15,47 23,66 34,94 32,103 21,109 8,125 11,128 22,135 34,132 48,114 59,111 74,109 87,108 100,112 116,97 124,73 120,52 127,25 123,24 113,25 100,33 88,38 81];
