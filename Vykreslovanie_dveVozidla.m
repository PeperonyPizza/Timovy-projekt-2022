function [] = Vykreslovanie_dveVozidla(riadok_cesta,stlpec_cesta,pozicia1,pozicia,draha,start,cesta,checkpoints)
...
% Farba ciela (cervena)
prostredie(pozicia(1,1),pozicia(1,2),1) = 210;
prostredie(pozicia(1,1),pozicia(1,2),2) = 105;
prostredie(pozicia(1,1),pozicia(1,2),3) = 30;
